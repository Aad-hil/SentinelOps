...
_CAUSAL_REQUIREMENTS = {
    ...
    "H5": (("query", "query change"), ("lock", "contention", "slow", "resource pressure"), ("latency", "cpu", "error")),
    ...
    "H9": (("write transaction", "transaction", "new data shape", "expensive"), ("expensive", "cpu", "resource"), ("latency", "timeout", "error")),
